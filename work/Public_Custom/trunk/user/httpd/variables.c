...
#include "common.h"
    ...
    struct variable variables_AdbybyConf[] = {
			...
			{"adbyby_add", "", NULL, EVM_RESTART_ADBYBY},
			{"adbyby_set", "", NULL, EVM_RESTART_ADBYBY},
			{"adbyby_own_rule", "", NULL, EVM_RESTART_ADBYBY},
			{"md5_json_1", "", NULL, EVM_RESTART_ADBYBY},
			{"lazy_txt_1", "", NULL, EVM_RESTART_ADBYBY},
			{"video_txt_1", "", NULL, EVM_RESTART_ADBYBY},
			{"md5_json_2", "", NULL, EVM_RESTART_ADBYBY},
			{"lazy_txt_2", "", NULL, EVM_RESTART_ADBYBY},
			{"video_txt_2", "", NULL, EVM_RESTART_ADBYBY},
