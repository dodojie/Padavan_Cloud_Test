...
$j(document).ready(function() {
	...
	init_itoggle('adbyby_own_rule',change_adbyby_rules);
...
function change_adbyby_rules(){
if(document.form.adbyby_rules_3.checked==true){
	var m = document.form.adbyby_rules_3.checked;	showhide_div('md5_json', m);
	showhide_div('md5_json_2', m);
	showhide_div('lazy_txt_2', m);
	showhide_div('video_txt_2', m);
	}else{
	showhide_div('md5_json_2', false);
	showhide_div('lazy_txt_2', false);
	showhide_div('video_txt_2', false);
}
}
...
<div class="wrapper">
						...
						<div class="box well grad_colour_dark_blue">
                            ...
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
								...
								<div class="row-fluid">
									...
									<div>第三方规则：【<% nvram_get_x("", "adbyby_user3"); %>】条 | 用户自定义规则：【<% nvram_get_x("", "adbyby_user"); %>】条</div>
									<div> </div>
									</div>
	...
	<tr id="adbyby_own_rule_tr" >
		<th width="50%">
			Adbyby内置规则:
		</th>
	<td>
		<label class="radio inline">
			<input type="radio" name="adbyby_own_rule" id="adbyby_rules_1" value="0" onclick="change_adbyby_rules();" <% nvram_match_x("", "adbyby_own_rule", "0", "checked"); %>/>禁用
		</label>
		<label class="radio inline">
			<input type="radio" name="adbyby_own_rule" id="adbyby_rules_2" value="1" onclick="change_adbyby_rules();" <% nvram_match_x("", "adbyby_own_rule", "1", "checked"); %>/>默认
		</label>
		<label class="radio inline">
			<input type="radio" name="adbyby_own_rule" id="adbyby_rules_3" value="2" onclick="change_adbyby_rules();" <% nvram_match_x("", "adbyby_own_rule", "2", "checked"); %>/>自定义
		</label>
		<div><span style="color:#888;">修改后，建议手动关闭adbyby，再开启以删除旧规则</span></div>
	</td>
	</tr>
	<tr id="md5_json_2" style="display:none;">
		<th style="border-top: 0 none;">md5.json文件地址:</th>
		<td style="border-top: 0 none;">
			<input type="text" maxlength="255"  class="none" size="100" name="md5_json_2" value="<% nvram_get_x("","md5_json_2"); %>"/>
		</td>
	</tr>
	<tr id="lazy_txt_2" style="display:none;">
		<th style="border-top: 0 none;">lazy.txt文件地址:</th>
		<td style="border-top: 0 none;">
			<input type="text" maxlength="255"  class="none" size="100" name="lazy_txt_2" value="<% nvram_get_x("","lazy_txt_2"); %>"/>
		</td>
	</tr>
	<tr id="video_txt_2" style="display:none;">
		<th style="border-top: 0 none;">video.txt文件地址:</th>
		<td style="border-top: 0 none;">
			<input type="text" maxlength="255"  class="none" size="100" name="video_txt_2" value="<% nvram_get_x("","video_txt_2"); %>"/>
		</td>
	</tr>
											<tr>
											<th width="50%">加载Anti_AD/Host规则至:</th>
											<td>
												<select name="adbyby_add" class="input">
													<option value="0" <% nvram_match_x("","adbyby_add", "0","selected"); %>>Dnsmasq</option>
													<option value="1" <% nvram_match_x("","adbyby_add", "1","selected"); %>>SmartDNS</option>
												</select>
											</td>
										</tr>
										...
										<tr id="adbyby_update_tr">
											...
											<td>
												<select name="adbyby_update" class="input" style="width: 60px;">
													...
													<option value="1" <% nvram_match_x("","adbyby_update", "1","selected"); %>>三天</option>
													<option value="2" <% nvram_match_x("","adbyby_update", "2","selected"); %>>关闭</option>
													<option value="3" <% nvram_match_x("","adbyby_update", "3","selected"); %>>每周</option>
													<option value="4" <% nvram_match_x("","adbyby_update", "4","selected"); %>>每月</option>
												</select>
										...
										<tr>
                                            <th width="50%">anti-AD for DNSmasq下载地址:</th>
                                            <td>
										...
										<tr>
											<td colspan="3">
												<i class="icon-hand-right"></i> <a href="javascript:spoiler_toggle('script15')"><span>DNSmasq hosts规则下载列表(一行一个地址):</span></a>
												<div id="script15">
