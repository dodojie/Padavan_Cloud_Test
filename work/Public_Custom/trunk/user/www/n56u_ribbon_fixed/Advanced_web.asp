							...
							<div class="round_bottom">
								<div class="row-fluid">
									...
									<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
										...
										<tr id="row_wsqm" style="display:none">
											<th width="50%" >QoS限速</th>
											<td>
													<div class="main_itoggle">
													<div id="w_sqm_on_of">
														<input type="checkbox" id="w_sqm_fake" <% nvram_match_x("", "w_sqm", "1", "value=1 checked"); %><% nvram_match_x("", "w_sqm", "0", "value=0"); %>  />
													</div>
												</div>
												<div style="position: absolute; margin-left: -10000px;">
													<input type="radio" value="1" name="w_sqm" id="w_sqm_1" class="input" <% nvram_match_x("", "w_sqm", "1", "checked"); %> /><#checkbox_Yes#>
													<input type="radio" value="0" name="w_sqm" id="w_sqm_0" class="input" <% nvram_match_x("", "w_sqm", "0", "checked"); %> /><#checkbox_No#>
												</div>
											</td>
										</tr>
											<td colspan="2">
