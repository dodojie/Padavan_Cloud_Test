...
function showSystemInfo(cpu_now,force){
	...
	if ('<% nvram_get_x("", "adbyby_enable"); %>' == '1')
...
var button_script_1 =  '<% nvram_match_x("","adbyby_enable", "1", "btn-info"); %>';
var button_script_2 =  '<% nvram_match_x("","sdns_enable", "1", "btn-info"); %>';
...
function show_banner(L3){
	...
	if (found_app_adbyby()){
	bc += '    <td style="border: 0 none; min-width: 188px;"><div class="form-inline"><input type="button" id="wifi2_b" class="btn btn-mini '+enabled2Gclass+'" style="'+style_2g+'" value='+title_2g+' onclick="go_setting(2);">&nbsp;<input type="button" id="wifi5_b" style="'+style_5g+'" class="btn btn-mini '+enabled5Gclass+'" value="5G" onclick="go_setting(5);">&nbsp;<input type="button" id="button_script1" style="width:66px;" class="btn btn-mini '+button_script_1+'" value="Adbyby" onclick="button_script1();"></div></td>\n';
	}
	else{
...
function button_script2(){
	location.href = "Advanced_smartdns.asp";
}
