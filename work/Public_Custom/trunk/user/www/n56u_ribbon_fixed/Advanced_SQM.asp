...
<% sqm_status(); %>
        $j(document).ready(function () {
            ...
            $j("#tab_sqm_cfg, #tab_sqm_qdisc, #tab_sqm_stats").click(function(){
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="box well grad_colour_dark_blue">
                                <h2 class="box_head round_top">QoS限速</h2>
				...
				<div>
					<ul class="nav nav-tabs" style="margin-bottom: 10px;">
						<li class="active">
                            ...
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
                                <li class="active">
                                    <a id="tab_sqm_cfg" href="#cfg">基本设置</a>
                                </li>
                                <li>
                                    <a id="tab_sqm_qdisc" href="#qdisc">队列管理</a>
                                <li>
                                <li>
                                    <a id="tab_sqm_stats" href="#stats">链接状态</a>
                                <li>
                                </ul>
                             </div>
                                    <div class="row-fluid">
                                        ...
                                        <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" style="margin-top: 10px;">
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    ...
                                                    <span class="label label-info" style="margin-left: 20px;"><% nvram_get_x("","sqm_qdisc"); %></span>
...
<div id="wnd_sqm_stats">
                                        <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                            ...
                                            <tr>
                                                <td colspan="3" style="border-top: 0 none; padding-bottom: 0px;">
                                                    <pre id="sqm_ingress_content"><% nvram_dump("sqm_qos.ingress.log",""); %></pre>
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                            ...
                                            <tr>
                                                <td colspan="3" style="border-top: 0 none; padding-bottom: 0px;">
                                                    <pre id="sqm_egress_content"><% nvram_dump("sqm_qos.egress.log",""); %></pre>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" style="text-align: right; padding-bottom: 0px;">
