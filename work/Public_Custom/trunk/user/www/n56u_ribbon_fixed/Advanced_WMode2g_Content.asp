                                    ...
                                    <table  width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <td colspan="3" style="border-top: 0 none;">
                                                <i class="icon-hand-right"></i><a href="javascript:spoiler_toggle('script21')"><span>ap_script【点击打开配置脚本】</span><div>&nbsp;<span style="color:#888;">增强功能：自动切换中继信号脚本【自动搜寻信道、自动搜寻信号】</span></div></a>
                                                <div id="script21" style="display:none;">
