...
function textarea_scripts_enabled(v){
	inputCtrl(document.form['scripts.inet_state_script.sh'], v);
}
                                    ...
                                    <table  width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <td colspan="3" style="border-top: 0 none;">
                                                <a href="javascript:spoiler_toggle('script23')"><span><#RunInetState#></span></a>
                                                <div id="script23" style="display:none;">
                                                    <textarea rows="24" wrap="off" spellcheck="false" maxlength="2097152" class="span12" name="scripts.inet_state_script.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.inet_state_script.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
