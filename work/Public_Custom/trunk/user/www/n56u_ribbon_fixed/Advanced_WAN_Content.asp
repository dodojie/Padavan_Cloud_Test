                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <select class="input" name="wan_proto" onchange="change_wan_type(this.value);fixed_change_wan_type(this.value);">
                                                    ...
                                                    <option value="pppoe" <% nvram_match_x("", "wan_proto", "pppoe", "selected"); %>>PPPoE: 拨号</option>
                                                    <option value="pptp" <% nvram_match_x("", "wan_proto", "pptp", "selected"); %>>PPTP: VPN</option>
                                                    <option value="l2tp" <% nvram_match_x("", "wan_proto", "l2tp", "selected"); %>>L2TP: VPN</option>
                                                </select>
                                            </td>
                                        </tr>
