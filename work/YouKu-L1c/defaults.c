...
struct nvram_pair router_defaults[] = {
	...
	{ "wl_dtim", "30" },			/* DTIM period */
	{ "wl_rts", "2347" },			/* RTS threshold */
	{ "wl_frag", "1492" },			/* Fragmentation threshold */
	...
	{ "koolproxy_txt_2", "https://cdn.jsdelivr.net/gh/houzi-/CDN/koolproxy.txt"},
	{ "daily_txt_2", "https://cdn.jsdelivr.net/gh/houzi-/CDN/daily.txt"},
	{ "kp_dat_2", "https://cdn.jsdelivr.net/gh/houzi-/CDN/kp.dat"},
	{ "koolproxy_update", "0"} ,
	...
	{ "adbyby_set", "0" },
	{ "adbyby_own_rule", "1" },
	{ "md5_json_1", "https://adbyby.coding.net/p/xwhyc-rules/d/xwhyc-rules/git/raw/master/md5.json" },
	{ "lazy_txt_1", "https://adbyby.coding.net/p/xwhyc-rules/d/xwhyc-rules/git/raw/master/lazy.txt" },
	{ "video_txt_1", "https://adbyby.coding.net/p/xwhyc-rules/d/xwhyc-rules/git/raw/master/video.txt" },
	{ "md5_json_2", "" },
	{ "lazy_txt_2", "https://opt.cn2qq.com/opt-file/lazy.txt" },
	{ "video_txt_2", "https://opt.cn2qq.com/opt-file/video.txt" },
	{ "adbyby_adb_update", "0" },
	{ "adbyby_update", "2" },
	...
	{ "trojan_local", "例如/media/你的u盘名/trojan" },
	{ "trojan_link", "https://cdn.jsdelivr.net/gh/vb1980/Padavan_CI/ssp/trojan" },
	{ "v2_local_enable", "0" },
	{ "v2_local", "例如/media/你的u盘名/v2ray" },
	{ "v2_link", "https://cdn.jsdelivr.net/gh/vb1980/Padavan_CI/ssp/v2ray" },
	{ "ss_mode", "1" },
	{ "ss_server", "127.0.0.1" },
	{ "ss_server_port", "8989" },
	{ "ss_key", "Secret" },
	...
	/*UnblockNeteaseMusic*/
	{ "wyy_enable", "0" },
	{ "wyy_link", "https://cdn.jsdelivr.net/gh/vb1980/Padavan_CI/unblockmusic/UnblockNeteaseMusic" },
	{ "wyy_apptype", "cloud" },
